...
namespace BlazeCommon
{
    public class BlazeClientConnection : ProtoFireClient
    {
        ...
        public override void OnPacketReceived(ProtoFirePacket packet)
        {
            ...
            if (component == null)
            {
                _logger.Warn($"Unable to handle notification - component {packet.Frame.Component} handler not found");
                return;
            }
            ...
            if (methodInfo == null)
            {
                _logger.Warn($"Unable to handle notification for component {packet.Frame.Component} - notification {packet.Frame.Command} handler not found");
                return;
            }
            ...
            {
                _logger.Error(e, $"Error while handling notification for component {packet.Frame.Component} - notification {packet.Frame.Command}");
            }
        }
